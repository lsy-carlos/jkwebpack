...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "_" + {"2":"a4e6e5dd"}[chunkId] + ".js"
/******/ 	}
/******/
...
var search_Search = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function loadJs() {
      ...
      __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(null, 5)).then(function (Text) {
        _this2.setState({
          Text: Text["default"]
        });
      });
